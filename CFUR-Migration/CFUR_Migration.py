...
def main(argv):
   ...
   payload1 = '<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:ns=\"http://www.cisco.com/AXL/API/10.5\"><soapenv:Body><ns:executeSQLUpdate><sql>update numplan set cfurvoicemailenabled = \'f\'</sql></ns:executeSQLUpdate></SOAP-ENV:Envelope>'
   req1 = s.post('https://' + hostname + ':8443/axl/', verify=False, auth=HTTPBasicAuth(username,password),headers=headers, data=payload1)
   print('CFUR External Voicemail Response: ' + req1.text)

   #Set CFUR Internal to not go to voicemail
   payload2 = '<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:ns=\"http://www.cisco.com/AXL/API/10.5\"><soapenv:Body><ns:executeSQLUpdate><sql>update numplan set cfurintvoicemailenabled = \'f\'</sql></ns:executeSQLUpdate></SOAP-ENV:Envelope>'
   req2 = s.post('https://' + hostname + ':8443/axl/', verify=False, headers=headers, data=payload2)
   print('\nCFUR Internal Voicemail Response: ' + req2.text)

   #Set CFUR External Number
   payload3 = '<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:ns=\"http://www.cisco.com/AXL/API/10.5\"><soapenv:Body><ns:executeSQLUpdate><sql>update numplan set cfurdestination=dnorpattern</sql></ns:executeSQLUpdate></SOAP-ENV:Envelope>'
   req3 = s.post('https://' + hostname + ':8443/axl/', verify=False, headers=headers, data=payload3)
   print('\nCFUR External Extension Response: ' + req3.text)

   #Set CFUR Internal Number
   payload4 = '<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:ns=\"http://www.cisco.com/AXL/API/10.5\"><soapenv:Body><ns:executeSQLUpdate><sql>update numplan set cfurintdestination=dnorpattern</sql></ns:executeSQLUpdate></SOAP-ENV:Envelope>'
   req4 = s.post('https://' + hostname + ':8443/axl/', verify=False, headers=headers, data=payload4)
   print('\nCFUR Internal Extension Response: ' + req4.text)

   #Set CFUR External CSS Number
   payload5 = '<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:ns=\"http://www.cisco.com/AXL/API/10.5\"><soapenv:Body><ns:executeSQLUpdate><sql>update numplan set fkcallingsearchspace_cfur= (select pkid from callingsearchspace where name=\'' + cfur_css + '\')</sql></ns:executeSQLUpdate></SOAP-ENV:Envelope>'
   req5 = s.post('https://' + hostname + ':8443/axl/', verify=False, headers=headers, data=payload5)
   print('\nCFUR External CSS Response: ' + req5.text)

   #Set CFUR Internal CSS Number
   payload6 = '<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:ns=\"http://www.cisco.com/AXL/API/10.5\"><soapenv:Body><ns:executeSQLUpdate><sql>update numplan set fkcallingsearchspace_cfurint= (select pkid from callingsearchspace where name=\'' + cfur_css + '\')</sql></ns:executeSQLUpdate></SOAP-ENV:Envelope>'
   req6 = s.post('https://' + hostname + ':8443/axl/', verify=False, headers=headers, data=payload6)
   print('\nCFUR Internal CSS Response: ' + req6.text)
